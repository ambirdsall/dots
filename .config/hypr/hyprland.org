...
Okay, but if this file is the source of truth, let's make it easy to work with:
...
#
#
bindle = , XF86LaunchA, exec, ~/bin/kbd-backlight-down
bindle = , XF86Search, exec, ~/bin/kbd-backlight-up
