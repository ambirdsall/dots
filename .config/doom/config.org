...
#+end_src
* buffers, windows, frames, workspaces... you know, emacs shit [0/1]
** scratch buffer
...
#+end_src
** non-language-specific IDE shit [0/4]
...
(use-package! lsp-tailwindcss
  :after lsp)
#+end_src
** there are more languages under the sun than ~:lang~ can speak [0/1]
*** python
#+begin_src elisp
(after! dap-mode
