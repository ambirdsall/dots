...
(use-package! evil-textobj-line
  :after evil)
#+end_src
* buffers, windows, frames, workspaces... all that emacs shit [0/1]
...
(use-package! lsp-tailwindcss
  :after lsp)
#+end_src
** there are more languages under the sun than ~:lang~ can speak [0/2]
*** python
...
* some packages feel like self-contained apps
** {ma,}git
