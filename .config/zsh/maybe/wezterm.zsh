...
if dots/at_hand brew; then
  __wezterm_completion_path=$(brew --prefix)/share/zsh/site-functions/_wezterm
# TODO same idea but for dnf
fi

if [[ -f $__wezterm_completion_path ]]; then
  source $__wezterm_completion_path
fi

# ============================================================================= #
# the following content was taken from
# https://github.com/wez/wezterm/raw/832c533c5f9e8d1c3315f2fbf96c125927a232f7/assets/shell-integration/wezterm.sh
# on 2024-09-19. No modifications were made except to the magic shellcheck comment, which
# was changed from "bash" to "zsh" and moved to the top of this file.
# ============================================================================= #
