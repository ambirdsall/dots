...
#+begin_src kdl :tangle no :noweb-ref keybinds
Mod+W hotkey-overlay-title="Display the focused workspace's name" { spawn "~/bin/niri-helper" "display"; }
Mod+Shift+W hotkey-overlay-title="Focus named workspace" { spawn "~/bin/niri-helper" "focus"; }
